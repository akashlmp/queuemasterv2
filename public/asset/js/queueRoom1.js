...
//   select2.name = 'advance[condition_place][]';
//   select2.innerHTML = '<option>host name</option><option>Page Path</option><option>page URL</option>';
//   newCell2.appendChild(select2);

//   const select3 = document.createElement('select');
//   select3.classList.add('form-select', 'form-control', 'FormInputBox');
//   select3.name = 'advance[condition][]';
//   select3.innerHTML = '<option>Contains</option><option>Does Not Contain</option><option>Equals</option><option>Does Not Equal</option>';
