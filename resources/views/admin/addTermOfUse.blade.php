...
<!-- <link rel="stylesheet" href="https://cdn.ckeditor.com/ckeditor5/42.0.1/ckeditor5.css"> -->
    ...
    <div class="card-body">
            <div class="col-12 col-md-6  col-lg-6 cardwidth">
                <form method="POST" action="{{ url('admin/addTermOfUsesave') }}">
                    @csrf
                    <div class="mb-3">
                        <label for="">Title</label>
                        <input type="text" class="form-control FormInputBox @error('title') is-invalid @enderror" id="title" name="title" value="{{ old('title', $termsOfUse->name ?? '') }}" required>
                        ...
                        <input type="hidden" class="form-control FormInputBox @error('slug') is-invalid @enderror" id="slug" name="slug" value="terms-of-use" required readonly>

                        
                     <label for="">Content</label>
                    <textarea class="addHeight" name="textData" id="editor" row="10" col="6">{{ old('textData', $termsOfUse->page_data ?? '') }}</textarea>
